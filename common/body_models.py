...
class MANODecimator:
    def __init__(self):
        data = np.load(
            "/storage/user/lud/dataset/arctic/data/arctic_data/data/meta/mano_decimator_195.npy", allow_pickle=True
        ).item()
        mydata = {}
...
MODEL_DIR = "/storage/user/lud/dataset/arctic/data/body_models/mano"
...
MANO_MODEL_DIR = "/storage/user/lud/dataset/arctic/data/body_models/mano"
SMPLX_MODEL_P = {
    "male": "/storage/user/lud/dataset/arctic/data/body_models/smplx/SMPLX_MALE.npz",
    "female": "/storage/user/lud/dataset/arctic/data/body_models/smplx/SMPLX_FEMALE.npz",
    "neutral": "/storage/user/lud/dataset/arctic/data/body_models/smplx/SMPLX_NEUTRAL.npz",
}
...
def build_subject_smplx(batch_size, subject_id):
    with open("/storage/user/lud/dataset/arctic/data/arctic_data/data/meta/misc.json", "r") as f:
        misc = json.load(f)
    vtemplate_p = f"/storage/user/lud/dataset/arctic/data/arctic_data/data/meta/subject_vtemplates/{subject_id}.obj"
