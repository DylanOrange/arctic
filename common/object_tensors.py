...
def construct_obj(object_model_p):
    ...
    top_sub_p = f"/storage/user/lud/dataset/arctic/data/arctic_data/data/meta/object_vtemplates/{obj_name}/top_keypoints_300.json"
    ...
    with open("/storage/user/lud/dataset/arctic/data/arctic_data/data/meta/object_meta.json", "r") as f:
...
def construct_obj_tensors(object_names):
    ...
    for k in object_names:
        object_model_p = f"/storage/user/lud/dataset/arctic/data/arctic_data/data/meta/object_vtemplates/%s" % (k)
