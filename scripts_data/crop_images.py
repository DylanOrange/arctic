...
def process_fname(fname, bbox_loose, sid, view_idx, pbar):
    ...
    out_p = fname.replace("/ssd/dylu/data/arctic/arctic_data/data/images", "./outputs/croppped_images")
...
def process_seq(seq_p):
    ...
    for view_idx in range(9):
        ...
        fnames = glob(
            f"/ssd/dylu/data/arctic/arctic_data/data/images/{sid}/{seq_name}/{view_idx}/*.jpg"
        )
