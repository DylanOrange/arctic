...
def main(split, protocol, eval_p):
    ...
    with open(
        f"/storage/user/lud/dataset/arctic/data/arctic_data/data/splits_json/protocol_{protocol}.json", "r"
    ) as f:
    ...
    out_folder = "/storage/user/lud/dataset/arctic/data/arctic_data/data/feat"
