...
def compute_loss(pred, gt, meta_info, args):
    ...
    #     "loss/mano/cam_t/l": (loss_cam_t_l, 0.01),
    #     "loss/object/cam_t": (loss_cam_t_o, 0.01),
    #     "loss/mano/kp2d/r": (loss_keypoints_r, 0.05),
    #     "loss/mano/kp3d/r": (loss_keypoints_3d_r, 0.05),
    #     "loss/mano/pose/r": (loss_regr_pose_r, 0.1),
    #     "loss/mano/beta/r": (loss_regr_betas_r, 0.00001),
    #     "loss/mano/kp2d/l": (loss_keypoints_l, 0.05),
    #     "loss/mano/kp3d/l": (loss_keypoints_3d_l, 0.05),
    #     "loss/mano/pose/l": (loss_regr_pose_l, 0.1),
    #     "loss/cd": (cd_ro + cd_lo, 0.01),
    #     "loss/mano/transl/l": (loss_transl_l, 0.01),
    #     "loss/mano/beta/l": (loss_regr_betas_l, 0.00001),
    #     "loss/object/kp2d": (loss_keypoints_o, 0.01),
    #     "loss/object/kp3d": (loss_keypoints_3d_o, 0.05),
    #     "loss/object/radian": (loss_radian, 0.01),
    #     "loss/object/rot": (loss_rot, 0.01),
    #     "loss/object/transl": (loss_transl_o, 0.01),
    # }
