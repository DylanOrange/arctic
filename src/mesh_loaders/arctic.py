...
def construct_object_meshes(cam_data, obj_name, layers, view_idx, distort):
    ...
    f3d_o = Mesh(
        filename=f"../original_packages/arctic/data/arctic_data/data/meta/object_vtemplates/{obj_name}/mesh.obj"
    ).faces
...
def construct_meshes(
    ...
    imgnames = [
        f"../original_packages/arctic/data/arctic_data/data/images/{subject}/{seq_name}/{view_idx}/{idx:05d}.jpg"
